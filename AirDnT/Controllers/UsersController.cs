...
namespace AirDnT.Controllers
{
    public class UsersController : Controller
    {
        ...
        {
            var airDnTContext = _context.User.Include(u => u.Owner);
        ...
        {
            ViewData["UserId"] = new SelectList(_context.Owner, "OwnerId", "OwnerId");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("UserId,UserName,Password")] User user)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.Owner, "OwnerId", "OwnerId", user.UserId);
            return View(user);
        }
